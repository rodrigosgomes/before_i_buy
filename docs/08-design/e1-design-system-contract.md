...
Do not include images, product URLs, text reasons for votes, persistent guest
...
| `BibDilemmaSummary` | Item, price, category, purpose, reason, and pause without image |
...
The fixture is fictitious, does not enter analytics, and does not authorize
images or URLs.
