...
Copy: Brazilian Portuguese, short, warm, and non-moralizing sentences. Do not add images, product URLs, vote comments/reasons, guest name/email, Reveal opt-in, decision, reflection, score, or AI. The public link preview is always generic. Before voting, no aggregates may be shown or inferred.
...
- image, URL, comment, guest name, or premature Reveal;
